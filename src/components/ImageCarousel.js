            ...
            <Carousel>
                ...
                <Carousel.Item className="carousel-item">
                    <img
                        ...
                        src='jamboretz-anne-scruffy.png'
                        alt='Scruffy'
                    />
                    <div className="image-overlay"></div>
                    <Carousel.Caption>
                ...
                {/* <Carousel.Item className="carousel-item">
                    <img
                        ...
                        src='jamboretz-anne-jazzconcert.png'
                        alt='Jazz Concert'
                    />
                    <div className="image-overlay"></div> */}
                {/* <Carousel.Caption>
                ...
                {/* <Carousel.Item className="carousel-item">
                    <img
                        ...
                        src='jamboretz-anne-curious.png'
                        alt='Curious'
                    />
                    <div className="image-overlay"></div> */}
                {/* <Carousel.Caption>
                ...
                <Carousel.Item className="carousel-item">
                    <img
                        ...
                        src='jamboretz-anne-marchingband.png'
                        alt='Marching Band'
                    />
                    <div className="image-overlay"></div>
                    {/* <Carousel.Caption>
                ...
                <Carousel.Item className="carousel-item">
                    <img
                        ...
                        src='jamboretz-anne-railroadhouse.png'
                        alt='Rail Road House'
                    />
                    <div className="image-overlay"></div>
                    {/* <Carousel.Caption>
                ...
                {/* <Carousel.Item className="carousel-item">
                    <img
                        ...
                        src='jamboretz-anne-streetlights.png'
                        alt='Street Lights'
                    />
                    <div className="image-overlay"></div> */}
                {/* <Carousel.Caption>
                ...
                <Carousel.Item className="carousel-item">
                    <img
                        ...
                        src='jamboretz-anne-womenportrait.png'
                        alt='Women Portrait'
                    />
                    <div className="image-overlay"></div>
                    {/* <Carousel.Caption>
                ...
                {/* <Carousel.Item className="carousel-item">
                    <img
                        ...
                        src='jamboretz-anne-abstract2.png'
                        alt='Abstract 2'
                    />
                    <div className="image-overlay"></div> */}
                {/* <Carousel.Caption>
                ...
                {/* <Carousel.Item className="carousel-item">
                    <img
                        ...
                        src='jamboretz-anne-abstract.png'
                        alt='Abstract'
                    />
                    <div className="image-overlay"></div> */}
                {/* <Carousel.Caption>
